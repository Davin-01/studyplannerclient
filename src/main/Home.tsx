  ...
  return (
    <>
      ...
      <div className="bg-gray-800 min-h-screen">
        {/* Hero Section */}
        <section className="hero bg-blue-600 text-white min-h-[calc(100vh-4rem)] flex flex-col justify-center items-center py-12 px-4 md:px-8 bg-cover bg-center" style={{ backgroundImage: 'url("https://unsplash.com/photos/assorted-book-lot-x7CDil50KKY")'  }}>
        ...
        <section className="about py-12 px-4 md:px-8 text-center">
          ...
          <p className="text-white text-700 text-lg md:text-xl mb-6 max-w-4xl mx-auto">
        ...
        <section className="features py-12 px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Courses Feature */}
            <div className="flex flex-col items-center bg-gray-300 shadow-lg rounded-lg p-6 transition-transform transform hover:scale-105">
              <img src="/onlinecourses.jpg" alt="Courses Icon" className="h-20 w-20 rounded-full mb-4" />
              <h3 className="text-xl font-semibold mb-2">Events</h3>
              <p className="text-gray-700 mb-4">
                Plan your events and manage your study sessions.
              </p>
              <Link
                to="/home/courses"
                className="bg-blue-500 text-white py-2 px-4 rounded hover:bg-gray-900 transition duration-200"
              >
                Plan Events
              </Link>
            </div>
        ...
        <footer className="bg-black border-t border-gray-200 py-6 mt-12">
          <p className="text-center text-white text-600 text-sm">© 2024 StudyPlanner. All rights reserved.</p>
        </footer>
      </div>
    </>
  );
